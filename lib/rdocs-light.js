...
(function () {
  ...
  function setAnchorsDisplay(display) {
    var anchors = shadowRoot.getElementById('rdocs-light-tooltip-anchors');
    if (anchors !== null) {
  ...
  function setNavigation(url, anchors) {
    ...
    var nav = shadowRoot.getElementById('rdocs-light-nav');
    nav.innerHTML = '';
    var addedElements = 0;
  ...
  function loadPackageData(data) {
    ...
    var packageVersion = shadowRoot.getElementById('rdocs-light-tooltip-header-package');
    packageVersion.innerText = data.package_name;
    packageVersion.href = data.url;
    var version = shadowRoot.getElementById('rdocs-light-tooltip-header-version');
  ...
  function loadTopicData(data) {
    ...
    var topic = shadowRoot.getElementById('rdocs-light-tooltip-header-topic');
    ...
    var usageDiv = shadowRoot.getElementById('rdocs-light-tooltip-usage');
    if (!showTopicUsageSection) {
      usageDiv.style.display = 'none';
    } else {
      var usageContentDiv = shadowRoot.getElementById('rdocs-light-tooltip-usage-content');
      usageContentDiv.innerHTML = '<code>' + (data.usage ? data.usage : '') + '</code>';
      usageDiv.style.display = 'block';
    }

    var argumentsDiv = shadowRoot.getElementById('rdocs-light-tooltip-arguments');
    if (!showTopicArgumentsSection) {
      argumentsDiv.style.display = 'none';
    } else {
      var argumentsContentDiv = shadowRoot.getElementById('rdocs-light-tooltip-arguments-content');
