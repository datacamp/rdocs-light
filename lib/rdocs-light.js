...
var packageView = __webpack_require__(8); // import './styles/_globals.scss';

var topicView = __webpack_require__(9);
  ...
  function findAllRDocLightDataAttributes() {
    ...
    links.forEach(function (linkElement) {
      return linkElement.addEventListener('mouseout', function () {
        return mouseOutListener(linkElement);
      });
    });
  }
