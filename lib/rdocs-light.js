...
var packageView = __webpack_require__(6); // import './styles/_globals.scss';

var topicView = __webpack_require__(7);

(function () {
  var TOOLTIP_HEIGHT = 252;
  var TOOLTIP_WIDTH = 302;
  ...
  function createTooltip() {
    ...
    tooltip.addEventListener('mouseover', function (event) {
      return onTooltipListenerOver(event);
    });
    tooltip.addEventListener('mouseout', function (event) {
      return onTooltipListener(event);
    });
  }
  ...
  function setToolTipPosition(box) {
    ...
    var top = box.top + body.scrollTop - TOOLTIP_HEIGHT;
...
module.exports = "<h3 id=\"rdocs-light-tooltip-title\"></h3>\r\n<div id=\"rdocs-light-tooltip-description\"></div>\r\n<a id=\"rdocs-light-tooltip-link\"\r\n class=\"rdocs-light-button rdocs-light-button-secondary\" href=\"\">Go To Documentation</a>";
