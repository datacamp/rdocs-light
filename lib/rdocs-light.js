...
(function () {
  ...
  var urlRegexes = ['/packages/(.*)/versions/(.*)/topics/(.*)', '/packages/(.*)/topics/(.*)', '/packages/(.*)'];
  ...
  function parseRDocLink(url) {
    ...
    var valid = void 0;
    urlRegexes.some(function (urlRegexString) {
      var urlRegex = new RegExp(urlRegexString, 'g');
  ...
  module.exports = {
    ...
    setWidgetsForRdocLinks: function setWidgetsForRdocLinks(find) {
