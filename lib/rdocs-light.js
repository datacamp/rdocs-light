...
var loaderView = __webpack_require__(8);
var notFoundView = __webpack_require__(9);
...
(function () {
  ...
  function loadTopicData(data) {
    ...
    var usageDiv = document.getElementById('rdocs-light-tooltip-usage');
    if (!showTopicUsageSection) {
      usageDiv.style.display = 'none';
    } else {
      var usageContentDiv = document.getElementById('rdocs-light-tooltip-usage-content');
      usageContentDiv.innerHTML = '<code>' + (data.usage ? data.usage : '') + '</code>';
      usageDiv.style.display = 'block';
    }

    var argumentsDiv = document.getElementById('rdocs-light-tooltip-arguments');
    if (!showTopicArgumentsSection) {
      argumentsDiv.style.display = 'none';
    } else {
      var argumentsContentDiv = document.getElementById('rdocs-light-tooltip-arguments-content');
